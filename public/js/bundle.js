...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ291ZGFhYmR1bGhtaWQyIiwiYSI6ImNsemwzZWRpajB3ZTIyaXIwcWt2M2I1M20ifQ.sMA19qswXHjNVQSVNKpnkA';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/goudaabdulhmid2/clzl5iu3i003501pdhap48jnf',
    // style URL
    //   center: [35, -32],
    //   zoom: 10,
    //   interactive: false,
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name, email, password, passwordConfrim) {
    var res;
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourID, dateID) {
    var stripe, session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _stripeJs.loadStripe)('pk_test_51Pn9VhAbTSDiQvdAJGnitFeZ0whGfmmf5tnfGZzlTR3fxj5ky9zx3AWZ7ZAtQB74inJkZtCOOIE7S28mtMAkdPso004dd3YcYx');
        case 2:
          stripe = _context.sent;
          _context.prev = 3;
          _context.next = 6;
          return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourID, "/").concat(dateID));
        case 6:
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/lib/index.mjs"}],"review.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var writeReview = exports.writeReview = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://127.0.0.1:8000/api/v1/tours/".concat(tourId, "/reviews"),
            data: {
              rating: rating,
              review: review
            }
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Submit successfuly!');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
exports.updateTour = exports.deleteTour = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "http://127.0.0.1:8000/api/v1/tours/".concat(tourId)
          });
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Delete successfuly!');
...
var updateTour = exports.updateTour = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(tourId, data) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Tour updated successfully!');
            window.setTimeout(function () {
              location.assign('/manageTours');
            }, 1000);
          }
...
var updateTourBtn = document.querySelector('.form--admin');
// Values
var dateID = document.getElementById('tour-date-id');
// Delegation
if (mapBox) {
...
if (bookingBtn) {
  bookingBtn.addEventListener('click', function (e) {
    ...
    (0, _stripe.bookTour)(tourID, dateID.value);
  });
}
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    var passwordConfrim = document.getElementById('password-confirm').value;
    (0, _login.signup)(name, email, password, passwordConfrim);
  });
}
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var tourID = submitReviewBtn.getAttribute('data-tour-id');
    var rating = document.getElementById('rating').value;
    var review = document.getElementById('review').value;
    (0, _review.writeReview)(tourID, rating, review);
  });
}
if (deleteBtns) {
  deleteBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var confirmDelete = confirm('Are you sure you want to delete this tour? This action cannot be undone.');
      if (confirmDelete) {
        var tourID = e.target.dataset.tourId;
        (0, _admin.deleteTour)(tourID);
      }
    });
  });
}
if (updateTourBtn) {
  updateTourBtn.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var formData, photoFile, images, i, startLocationDescription, startLocationCoordinates, startLocationAddress, selectedGuides, startDates, locations, tourId;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            ...
            startLocationDescription = document.getElementById('startLocation_description').value;
            startLocationCoordinates = document.getElementById('startLocation_coordinates').value.split(',').map(function (coord) {
              return parseFloat(coord.trim());
            });
            startLocationAddress = document.getElementById('startLocation_address').value;
            ...
            formData.append('startLocation[coordinates][]', startLocationCoordinates[0]);
            formData.append('startLocation[coordinates][]', startLocationCoordinates[1]);
            selectedGuides = _toConsumableArray(document.getElementById('guides').selectedOptions).map(function (option) {
              return option.value;
            });
            selectedGuides.forEach(function (guide) {
              return formData.append('guides[]', guide);
            });

            // Handle startDates
            startDates = document.querySelectorAll('.form__start-date');
            startDates.forEach(function (startDate, index) {
              var date = startDate.querySelector("input[name=\"startDates[".concat(index, "][date]\"]")).value;
              var participants = startDate.querySelector("input[name=\"startDates[".concat(index, "][participants]\"]")).value;
              var soldOut = startDate.querySelector("input[name=\"startDates[".concat(index, "][soldOut]\"]")).checked;
              formData.append("startDates[".concat(index, "][date]"), new Date(date).toISOString());
              formData.append("startDates[".concat(index, "][participants]"), participants);
              formData.append("startDates[".concat(index, "][soldOut]"), soldOut);
            });
            locations = document.querySelectorAll('.location-group');
            locations.forEach(function (location, index) {
              var description = location.querySelector("input[name=\"locations[".concat(index, "][description]\"]")).value;
              var coordinates = location.querySelector("input[name=\"locations[".concat(index, "][coordinates]\"]")).value.split(',').map(function (coord) {
                return parseFloat(coord.trim());
              });
              var address = location.querySelector("input[name=\"locations[".concat(index, "][address]\"]")).value;
              var day = location.querySelector("input[name=\"locations[".concat(index, "][day]\"]")).value;
              formData.append("locations[".concat(index, "][description]"), description);
              formData.append("locations[".concat(index, "][coordinates][]"), coordinates[0]);
              formData.append("locations[".concat(index, "][coordinates][]"), coordinates[1]);
              formData.append("locations[".concat(index, "][address]"), address);
              formData.append("locations[".concat(index, "][day]"), parseInt(day, 10));
            });
            tourId = e.target.querySelector('#update-tour').dataset.tourId; // for (let pair of formData.entries()) {
            //   console.log(pair[0], pair[1]);
            // }
            (0, _admin.updateTour)(tourId, formData);
          case 29:
          case "end":
            return _context2.stop();
        }
